        ...
        {doubled.map((item, i) => (
          ...
          >
            ...
            <div>
              ...
              <div className="text-[10px] text-muted-foreground/60 font-mono whitespace-nowrap">
                {item.sub}
              </div>
            </div>
          </div>
    ...
    <section id="trust" ref={ref} className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <span>
            Built on OpenZeppelin Contracts v5 — the most-used smart contract
